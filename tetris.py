...
class PygameView(ViewBase):
    ...
    def __init__(self, surf, fonts):
        ...
        self.end_msg = self.go_font.render(
            "GAME OVER", True, self.font_color)
    ...
    def show_game_over(self):
        ...
        self.surf.blit(
            self.end_msg, (300 - r.width // 2, 300 - r.height // 2))
...
class Tetris:
    ...
    def init(self):
        ...
        if pygame.font.get_init():
            self.fonts = {}
            self.fonts["game_over"] = pygame.font.SysFont(
                "ni7seg", 60)
    ...
    def main(self):
        ...
        pygame.time.set_timer(
            self.DROP_EVENT, self.get_level_speed(1))
